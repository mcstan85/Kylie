...
async def start_menu_private(message):
    ...
    if "help" in message.text:
        await message.reply_photo(photo=THUMBNAIL,caption="**ᴄʜᴏᴏꜱᴇ ʙᴀꜱɪᴄ ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ɢᴇᴛ ʙᴀꜱɪᴄ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅꜱ\nᴀɴᴅ ᴀᴅᴠᴀɴᴠᴇᴅ ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ɢᴇᴛ ᴀᴅᴠᴀɴᴠᴇᴅ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅꜱ.**",reply_markup=COMMAND_MENU_BUTTON,parse_mode="markdown")
    else:
...
async def command_menu(_, query):
    await query.answer()   
    await query.message.edit(text="**ᴄʜᴏᴏꜱᴇ ʙᴀꜱɪᴄ ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ɢᴇᴛ ʙᴀꜱɪᴄ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅꜱ\nᴀɴᴅ ᴀᴅᴠᴀɴᴠᴇᴅ ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ɢᴇᴛ ᴀᴅᴠᴀɴᴠᴇᴅ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅꜱ.**",reply_markup=COMMAND_MENU_BUTTON,parse_mode="markdown")    
